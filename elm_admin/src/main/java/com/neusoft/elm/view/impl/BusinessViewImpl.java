...
public class BusinessViewImpl implements BusinessView {
    ...
    @Override
    public void showBusinessList(List<Business> list) {
    ...
    @Override
    public void updateBusiness(Integer businessID) {//更新指定商家的信息
    ...
    @Override
    public void updateBusinessByPassword(Integer businessID) {//更新商家密码
        BusinessDao dao = new BusinessDaoImpl();
        Business business = dao.getBusinessById(businessID);
