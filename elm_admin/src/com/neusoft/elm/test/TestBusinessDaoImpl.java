...
public class TestBusinessDaoImpl {
	...
	@Test
	public void TestlistBusinessString(String businessName, String businessAddress) {
...
//        return list;
	...
	@Test
    public void TestcreateBusiness(String businessName) {//新建商家
        int businessID = 0;
...
//        return businessID;
	...
	@Test
    public void TestdeleteBusiness(int businessID) {
        int result ;
...
//    @Test
//    public void TestgetBusinessByIdByPass(Integer businessID, String password) {//business调用 需要ID password
...
//    }
    ...
    @Test
    public void TestcheckBusinessPassword(Integer businessID, String password) {//检查用户的密码是否正确
...
//        return passwordSearch.equals(password);
    ...
    @Test
    public void TestgetBusinessById(Integer businessID) {//admin调用 只需ID
...
//        return business;
    ...
    @Test
    public void TestupdateBusiness(Business business) {
        int result = 0;
...
//        return result;
    ...
    @Test
    public void TestupdateBusinessByPassword(Integer businessID, String password) {
        int result = 0;
